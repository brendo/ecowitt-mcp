...
export class CustomError extends Error {
  constructor(message, code, type = "server_error") {
    ...
    this.code = code;
    this.type = type; // Corresponds to MCP error types (e.g., "server_error", "external_service_error", "parameter_error", "device_error", "handler_error", "configuration_error", "timeout_error", "network_error")
